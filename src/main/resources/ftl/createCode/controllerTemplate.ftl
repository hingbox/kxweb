package com.hingbox.kxweb.controller.${packageName}.${objectNameLower};
...
import com.hingbox.kxweb.entity.Page;
import com.hingbox.kxweb.util.AppUtil;
import com.hingbox.kxweb.util.ObjectExcelView;
import com.hingbox.kxweb.util.Const;
import com.hingbox.kxweb.util.PageData;
import com.hingbox.kxweb.util.Tools;
import com.hingbox.kxweb.util.Jurisdiction;
import com.hingbox.kxweb.service.${packageName}.${objectNameLower}.${objectName}Service;
